...
const SolutionModal = forwardRef<HTMLDivElement, ModalProps>(
        ...
        <ModalContent>
          ...
          <Column>
            ...
            <ModalItem>
              ...
              <p>Additional information about PIM Community Edition.</p>
            </ModalItem>
            <ModalItem>
              <ModalItemContent>
                <Icon src="/user.png" alt="icon" width={20} height={20} />
          ...
          <FourthColumnWrapper>
            <ModalImage src="/navbar.jpg" alt="Description of image" width={200} height={150} />
            <ModalImageHeading>How to execute an AI for PX strategy</ModalImageHeading>
            <ModalImageHeading>AI Glossary Page</ModalImageHeading>
          </FourthColumnWrapper>
